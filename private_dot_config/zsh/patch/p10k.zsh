# Generated by Powerlevel10k configuration wizard on 2023-08-10 at 21:36 AEST.
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
	...
	local default_success_color=2
	local default_error_color=1

	#################
	## Normal mode ##
	#################
	
	local normal_symbol="$default_symbol"
	...
	local insert_symbol="$default_symbol"
	# local insert_color=3
	
	#################
	## Visual mode ##
	#################
	
	local visual_symbol="$default_symbol"
	local visual_color=31
	
	####################
	## Overwrite mode ##
	####################
	
	local overwrite_symbol="$default_symbol"
	local overwrite_color=99


	# Set up normal mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_FOREGROUND=${normal_color:-$default_success_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_FOREGROUND=${normal_color:-$default_error_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION=${normal_symbol:-$default_symbol}
  
	# Set up insert mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_FOREGROUND=${insert_color:-$default_success_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_FOREGROUND=${insert_color:-$default_error_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=${insert_symbol:-$default_symbol}
  
	# Set up visual mode
	typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_FOREGROUND=${visual_color:-$default_success_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_FOREGROUND=${visual_color:-$default_error_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION=${visual_symbol:-$default_symbol}

	# Set up overwrite mode
	typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_FOREGROUND=${overwrite_color:-$default_success_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIOWR_FOREGROUND=${overwrite_color:-$default_error_color}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION=${overwrite_symbol:-$default_symbol}


	# Default configurations that I haven't messed with. #
